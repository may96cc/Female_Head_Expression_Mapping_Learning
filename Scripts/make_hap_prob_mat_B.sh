...
#SBATCH -J mk_hap_prb_mat_B              # Job name
#SBATCH -e mk_hap_prb_mat_B_%j.err       # Error log file
#SBATCH --mail-user=myork@missouri.edu
#SBATCH --mail-type=FAIL,END
#SBATCH -o mk_hap_prb_mat_B.out          # Standard output file
